        ...
        <div className="theme-d5 text-white px-3 py-2">
            <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
                ...
                <div className="d-flex flex-wrap align-items-center gap-2">
                    <a className='nav-logo' href='/'><FontAwesomeIcon icon="fa-solid fa-car-on" style={{ fontSize: '1.5em' }}/></a>
                ...
                <a className="" href='/settings'><FontAwesomeIcon icon="fas fa-cog" style={{ fontSize: '1.5em' }}/></a>
