  ...
  return (
    <div className="about-content">
      ...
      <div className="top-text-section">
        <p>
          Text section regarding what we do as a group, how we started the idea,
      ...
      <div className="image-and-text-section">
        ...
        <div className="bottom-text-section">
          <p>
            Another text section regarding what we do as a group, how we started
            the idea, yadda yadda yadda <br />
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
